const heroes = [
    { name: "Spider Man", id: "spiderman", icon: "images/spider.jpg", color: "#E23636", secondary: "#01539D", attack: "🕸️", hidden: false },
    { name: "Iron Man", id: "ironman", icon: "images/iron.jpg", color: "#AA0505", secondary: "#F1C40F", attack: "⚡", hidden: false },
    { name: "Black Panther", id: "panther", icon: "images/bao.jpg", color: "#2c2c2c", secondary: "#6A0DAD", attack: "🗡️", hidden: false },
    { name: "Captain America", id: "cap", icon: "images/Captain.jpg", color: "#003366", secondary: "#C0C0C0", attack: "🛡️", hidden: false },
    { name: "Boss", id: "boss", icon: "images/boss.jpg", color: "#8B0000", secondary: "#FFD700", attack: "💀", hidden: false },
    { name: "Doctor Strange", id: "doctor", icon: "images/doctor.jpg", color: "#4B0082", secondary: "#FFD700", attack: "🔮", hidden: false },
    { name: "Hulk", id: "hulk", icon: "images/green.jpg", color: "#006400", secondary: "#8B4513", attack: "💪", hidden: false },
    { name: "Thor", id: "thor", icon: "images/thor.jpg", color: "#4169E1", secondary: "#FFD700", attack: "⚡", hidden: false },
    { name: "Mario", id: "mario", icon: "images/m3.png", color: "#E52521", secondary: "#FFFFFF", attack: "🍄", hidden: false },
    { name: "Luigi", id: "luigi", icon: "images/m4.png", color: "#00A651", secondary: "#FFFFFF", attack: "⭐", hidden: false },
    { name: "Peach", id: "peach", icon: "images/m5.png", color: "#FFB6C1", secondary: "#FF69B4", attack: "👑", hidden: false },
    { name: "Mickey", id: "mickey", icon: "images/mouse.jpg", color: "#FF0000", secondary: "#FFFF00", attack: "⭕", hidden: false },
    { name: "Pikachu", id: "pikachu", icon: "images/bikachao.jpg", color: "#FFD700", secondary: "#FF6347", attack: "⚡", hidden: true }
];
...
function updateTimerDisplay() {
    ...
    if (timerBar && timerText) {
        const percentage = Math.max(0, 100 - (timeElapsed / 15 * 100));
        ...
        if (timeElapsed <= 5) {
            ...
            timerBar.style.background = 'linear-gradient(90deg, #FFC107, #FF9800)';
        } else {
            timerBar.style.background = 'linear-gradient(90deg, #f44336, #E53935)';
        }
    }
}
...
function checkAnswer(selected, btn) {
    ...
    if (selected === currentQuestion.answer) {
        ...
        if (timeElapsed <= 5) {
            feedbackArea.innerHTML = '<span class="feedback-correct">⚡ 閃電答對！雙倍攻擊！</span>';
            setTimeout(() => {
                playerAttack(true);
            }, 500);
        } else {
            feedbackArea.innerHTML = '<span class="feedback-correct">✅ 答對了！發動攻擊！</span>';
            setTimeout(() => playerAttack(false), 500);
        }
    } else {
        playSound('wrong');
...
function playerAttack(isDoubleAttack = false) {
    if (isGameOver) return;
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                if (computerHP <= 0) {
                    ...
                    setTimeout(() => {
                        feedbackArea.innerHTML = '<span class="feedback-attack">🔥 第二次攻擊！</span>';
                        playerAttack(false);
                    }, 800);
                } else {
